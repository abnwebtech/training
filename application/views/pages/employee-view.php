  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        -------------------------->
        <div class="row">
            <div class="col-lg-3"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa, corporis quaerat quo. Nesciunt nam provident officiis ab nostrum itaque. Reiciendis minus animi voluptatem, dolore dolorem neque ex harum numquam, a!</p></div>
            <div class="col-lg-4" >
                <a class="btn btn-default" href="<?php echo site_url('employees/add'); ?>">ADD EMPLOYEE</a>
